...
code. Although it lives under `src/utils`, it is independent of the Harness
runtime: builders read source datasets and write ordinary files, without
importing Domain, Bench, Runner, or any Agent implementation.
